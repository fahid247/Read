    ...
    <section className="bg-base-200 py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold text-primary playfair">
          ...
          <p className="mt-4 text-base-content/70 max-w-3xl mx-auto text-lg inter">
            Thousands of readers and librarians across Bangladesh trust ReadOnRoute for reliable book delivery and seamless order management.
          </p>
        </div>
        ...
        >
          {testimonials.map((review, index) => (
            ...
            >
              ...
              {/* Message */}
              <p className="text-base-content/70 text-sm leading-relaxed mb-6">“{review.message}”</p>
              ...
              <div className="flex items-center gap-3 mt-auto">
                ...
                <div>
                  ...
                  <p className="text-xs text-base-content/50">{review.role} • {review.location}</p>
                </div>
              </div>
            </motion.div>
          ))}
